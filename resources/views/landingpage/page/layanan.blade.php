    ...
    <div class="layanan" id="layanan">
        ...
        <div class="konten">
            <div class="konten-kanan">
                <div class="img-layanan1">
                    <img src="{{ asset('images/img-landingpage/layanan-img1.png') }}" alt="" class="fade-in-up">
                </div>
                <div class="img-layanan2">
                    <img src="{{ asset('images/img-landingpage/layanan-img2.png') }}" alt="" class="fade-in-up">
                </div>
                <div class="img-layanan3">
                    <img src="{{ asset('images/img-landingpage/layanan-img3.png') }}" alt="" class="fade-in-up">
                </div>
                <div class="img-layanan4">
                    <img src="{{ asset('images/img-landingpage/layanan-img4.png') }}" alt="" class="fade-in-up">
                </div>
                <div class="img-layanan5">
                    <img src="{{ asset('images/img-landingpage/layanan-img5.png') }}" alt="" class="fade-in-up" id="layanan-spin1">
                </div>
                <div class="img-layanan6">
                    <img src="{{ asset('images/img-landingpage/layanan-img5.png') }}" alt="" class="fade-in-up" id="layanan-spin2">
                </div>
                <div class="img-layanan7">
                    <img src="{{ asset('images/img-landingpage/layanan-img6.png') }}" alt="" class="fade-in-up" id="float">
                </div>
            </div>
            ...
            <div class="konten-kiri fade-in-up">
                <div class="layanan-info">
                    <div class="circular-check">
                        <img src="{{ asset('images/img-landingpage/check-circle.png') }}" alt="check">
                    </div>
