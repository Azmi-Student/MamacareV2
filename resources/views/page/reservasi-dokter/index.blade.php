...
@section('content')
    <div class="container mx-auto px-4 pt-6 pb-24" x-data="{
        ...
        @if (session('success'))
            <div
                class="mb-8 max-w-2xl mx-auto bg-white border-2 border-[#FF3EA5] text-[#FF3EA5] p-4 rounded-2xl font-bold flex items-center gap-3 shadow-[4px_4px_0px_0px_#FF3EA5]">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                @foreach (['09:00', '10:00', '11:00', '13:00', '14:00', '16:00', '19:00', '20:00'] as $time)
                                    <label class="cursor-pointer group">
                                        ...
                                        <div
                                            class="text-center py-2.5 border-2 border-[#FF3EA5] bg-white rounded-xl text-xs font-bold text-[#FF3EA5]
