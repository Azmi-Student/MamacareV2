<nav class="fixed bottom-0 left-0 w-full bg-white border-t-2 border-[#FF3EA5] z-50 lg:hidden pb-safe">
    ...
    <div class="flex justify-around items-center h-16 px-2">
        ...
        @php
            ...
            // Cek status aktif untuk tombol Home
        ...
        <a href="{{ route($dashboardRoute) }}" 
           ...
           {{ $isHomeActive 
            ...
            <svg class="w-5 h-5 stroke-[2.5px] {{ $isHomeActive ? 'text-white' : 'text-[#FF3EA5]' }}" 
                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
            </svg>
            <span class="text-[9px] font-black uppercase tracking-wide {{ $isHomeActive ? 'text-white' : 'text-[#FF3EA5]' }}">
                Home
            </span>
        </a>
        ...
        @if(auth()->user()->role === 'mama')
            {{-- TAMPILKAN MENU DOKTER UNTUK MAMA --}}
            <a href="#" 
               class="flex flex-col items-center justify-center w-full h-12 space-y-0.5 rounded-lg border-2 transition-all duration-200 group
        ...
        @elseif(auth()->user()->role === 'admin')
            {{-- TAMPILKAN MENU KELOLA USER UNTUK ADMIN --}}
            <a href="{{ route('admin.dashboard') }}" 
               ...
               {{ request()->routeIs('admin.dashboard') && !request()->is('admin/dashboard') 
                ...
                <svg class="w-5 h-5 stroke-[2.5px] text-[#FF3EA5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <span class="text-[9px] font-black uppercase tracking-wide text-[#FF3EA5]">
                    Users
                </span>
            </a>
        @endif
        ...
        <a href="{{ route('profile.edit') }}" 
           ...
           {{ request()->routeIs('profile.edit') 
            ...
            <svg class="w-5 h-5 stroke-[2.5px] {{ request()->routeIs('profile.edit') ? 'text-white' : 'text-[#FF3EA5]' }}" 
                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-[9px] font-black uppercase tracking-wide {{ request()->routeIs('profile.edit') ? 'text-white' : 'text-[#FF3EA5]' }}">
                Settings
            </span>
        </a>
