...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden rounded-3xl border-2 border-[#FF3EA5] shadow-[6px_6px_0px_0px_#FF3EA5] mb-8">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Card 1: Total Pasien --}}
                    <div class="p-5 bg-white border-2 border-[#FF3EA5] rounded-2xl shadow-sm hover:-translate-y-1 transition-transform">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-full bg-pink-50 flex items-center justify-center text-[#FF3EA5]">
                    ...
                    <div class="p-5 bg-[#FF3EA5] border-2 border-[#FF3EA5] rounded-2xl shadow-sm hover:-translate-y-1 transition-transform">
                        <div class="flex items-center gap-4">
        ...
        <div class="bg-white overflow-hidden rounded-3xl border-2 border-[#FF3EA5] shadow-[6px_6px_0px_0px_#FF3EA5]">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-xs font-bold bg-pink-50 text-[#FF3EA5] px-3 py-1 rounded-full border border-pink-100">
                        Database Pasien
                    </span>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-pink-50 border-b-2 border-pink-100">
                                <th class="p-4 text-xs font-black uppercase text-[#FF3EA5] tracking-wider">Nama Bunda</th>
                                <th class="p-4 text-xs font-black uppercase text-[#FF3EA5] tracking-wider">Email</th>
                                <th class="p-4 text-xs font-black uppercase text-[#FF3EA5] tracking-wider text-center">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-pink-100">
                            ...
                            <tr class="hover:bg-pink-50/50 transition duration-150">
                                <td class="p-4 text-sm font-bold text-[#C21B75] flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-full bg-pink-100 text-[#FF3EA5] flex items-center justify-center font-black text-xs">
                                ...
                                <td class="p-4 text-center">
                                    <button class="bg-white border-2 border-[#FF3EA5] text-[#FF3EA5] px-4 py-1.5 rounded-lg text-xs font-black uppercase shadow-[2px_2px_0px_0px_#FF3EA5] hover:shadow-none hover:translate-y-[1px] hover:translate-x-[1px] transition-all">
                                        Detail
                                    </button>
                                </td>
                            </tr>
